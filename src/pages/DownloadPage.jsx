      ...
      <section className="download-section public-content-section">
        <div className="download-grid">
          <article className="download-card">
            <span className="download-card-number">01 — Firmware</span>
          ...
          <article className="download-card">
            <span className="download-card-number">02 — Docs</span>
            ...
            <button className="btn-primary" type="button">{t("Leer Guia")}</button>
          </article>
        </div>
      </section>
    </PublicPageShell>
